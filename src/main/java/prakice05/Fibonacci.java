...
public class Fibonacci {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Lütfen 47 den kücük bir tam sayi giriniz");

        int sayi = scan.nextInt();

        fibonacci(sayi);

    }// min dis klas olusturmak icin bunun disina cikariz
    ...
    public static void fibonacci(int sayi) {
        ...
        }}else System.out.println("Lütfen gcerli bir sayi giriniz");
        {}
